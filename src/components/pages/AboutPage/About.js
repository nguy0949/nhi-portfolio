                ...
                <div className={styles.main_content}>
                    ...
                    <div className={styles.introduction}>
                        ...
                        <p className={styles.no_margin}>
                            ...
                            <br />I am also an alumnus of Algonquin College, I majored
                            <br />in Interactive Media Design, delving into the realms of graphic design, content creation, video production, and UI/UX.
                        </p>
                        <p className={styles.no_margin}>
                            Proficient in Adobe Creative Suits and Blender software,
                            <br />I bring a seamless blend of creativity and technical expertise.
                        </p>
                    </div>
                </div>
